...
try:
    ...
    export CXXFLAGS="-O3 -pipe -ffast-math -feliminate-unused-debug-types -funroll-loops" AR=aarch64-elk-linux-ar
    ./generate --cmake-args="-DWITH_RPC_INTERFACE=off -DVST2_SDK_PATH=/code/VST2_SDK -DWITH_JACK=off -DWITH_LV2=off -DWITH_LV2_MDA_TESTS=off -DWITH_UNIT_TESTS=off"  -b
